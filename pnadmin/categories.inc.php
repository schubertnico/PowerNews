...
<tr><td bgcolor="#3F5070" align="center"><b>
       ...
       <b class="headline"><?php echo L_CAT_TITLE_CATEGORIES; ?></b>
...
if (isset($_GET['subpage']) && $_GET['subpage']) {
    ...
    ?><center><?php echo L_ALL_CHOOSESUBPAGE; ?><br><br><a href="index.php?page=categories&subpage=add"><?php echo L_CAT_ADDCAT; ?></a> | <a href="index.php?page=categories&subpage=show"><?php echo L_CAT_SHOWCATS; ?></a></center><?php
}
?>
