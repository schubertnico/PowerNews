...
<tr>
    <td bgcolor="#3F5070" align="center"><b>
            ...
            <b class="headline"><?php echo L_TITLE_OTHER; ?></b>
...
<td bgcolor="#001F3F" valign="top">
  ...
  if (isset($_GET['subpage']) && $_GET['subpage']) {
      ...
      <center><?php echo L_ALL_CHOOSESUBPAGE; ?><br><br><a
              href="index.php?page=other&subpage=help"><?php echo L_OTHER_HELP; ?></a> | <a
              href="index.php?page=other&subpage=license"><?php echo L_OTHER_LICENSE; ?></a></center><?php
  }
?>
