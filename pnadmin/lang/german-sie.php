...
define('L_CAT_FILLALL', 'Sie m&uuml;ssen einen Titel und eine Beschreibung angeben');
...
define('L_CAT_PICDESC', 'Bild f&uuml;r die neue Kategorie');
...
define('L_CAT_CHOOSECAT', 'Sie m&uuml;ssen eine Kategorie ausw&auml;hlen!');
...
define('L_CONF_FILLALL', 'Sie m&uuml;ssen alle Felder ausf&uuml;llen!');
...
define('L_MENU_CHOOSESECTION', 'W&auml;hlen Sie eine Sektion');
...
define('L_USR_NICKANDPW', 'Sie m&uuml;ssen Nickname und Passwort angeben');
define('L_USR_NICKANDEMAIL', 'Sie m&uuml;ssen Nickname und E-Mail Adresse angeben!');
...
define('L_USR_CHOOSEUSER', 'Bitte w&auml;hlen Sie einen Benutzer aus');
...
define('L_USR_SHOWUSR_DESC', 'Klicken Sie auf einen Nickname um den Benutzer zu editieren! Es werden 25 Benutzer pro Seite angezeigt.');
define('L_USR_SEARCHSTRINGNEEDED', 'Sie m&uuml;ssen einen Suchbegriff angeben');
define('L_USR_SEARCHUSR', 'Benutzer suchen');
define('L_USR_SEARCHFIELD', 'Suchfeld');
define('L_USR_SEARCHFIELD_DESC', 'W&auml;hlen Sie aus in welchem Feld gesucht werden soll');
define('L_USR_USRID', 'Benutzer-ID');
define('L_USR_SEARCHSTRING', 'Suchbegriff');
define('L_USR_SEARCHSTRING_DESC', 'Geben Sie an nach was Sie suchen wollen');
define('L_USR_PROFILEEDITED', 'Ihr Benutzerprofil wurde editiert!');
...
define('L_USR_INSERTNICKNAMEANDEMAIL', 'Sie m&uuml;ssen Nickname und eMail angeben!');
...
define('L_TEMPL_USERADDEDMAIL', 'Benutzer hinzugef&uuml;gt - eMail');
define('L_TEMPL_USERADDEDMAIL_DESC', 'eMail wenn ein Benutzer von einem Admin hinzugef&uuml;gt wurde');
define('L_TEMPL_USEREDITEDMAIL', 'Benutzer editiert - eMail');
define('L_TEMPL_USEREDITEDMAIL_DESC', 'eMail wenn ein Benutzer von einem Admin editiert wurde');
define('L_TEMPL_USERREGISTEREDMAIL', 'Benutzer registriert - eMail');
define('L_TEMPL_USERREGISTEREDMAIL_DESC', 'eMail wenn sich ein Benutzer registriert hat');
define('L_TEMPL_DATAMAIL', 'Benutzerdaten - eMail');
define('L_TEMPL_DATAMAIL_DESC', 'eMail sich ein Benutzer seine Daten zuschicken l&auml;sst');
define('L_TEMPL_CHOOSETEMPLATE', 'Sie m&uuml;ssen ein Template w&auml;hlen');
define('L_TEMPL_SHOW_DESC', 'Per Klick auf ein Template kann dieses editiert werden.');
define('L_TEMPL_TITLENEEDED', 'Sie m&uuml;ssen einen Titel f&uuml;r das neue Template angeben!');
...
define('L_TEMPL_INSERTALL', 'Sie m&uuml;ssen alle Felder ausf&uuml;llen!');
...
define('L_PERM_INSERTNICK', 'Sie m&uuml;ssen einen Nickname angeben!');
...
define('L_PERM_SHOW_DESC', 'Klicken Sie auf einen Nickname um die Berechtiungen zu editieren.');
...
define('L_NEWS_CHOOSENEWS', 'Sie m&uuml;ssen einen g&uuml;ltigen Newseintrag ausw&auml;hlen!');
define('L_NEWS_DATE', 'Datum');
define('L_NEWS_SHOW_DESC', 'Klicken Sie auf einen Newstitel um die News zu editieren.');
...
define('L_NEWS_RELATEDLINKS_DESC', 'Hier k&ouml;nnen Sie Related Links zu diesem Newseintrag posten');
