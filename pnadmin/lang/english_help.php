...
<!-- USER -->
  ...
  <ul>
    ...
    E-Mail mit seinen Daten zukommen zu lassen damit dieser auch dar&uuml;ber informiert ist, dass er jetzt
    registriert ist.
...
<!-- PERMISSIONS -->
  ...
  <ul>
    ...
    <a href="index.php?page=permissions&subpage=add">Hinzuf&uuml;gen der Berechtigungen</a>
    nicht &uuml;ber seine Adminrechte informiert, man sollte ihn deshalb selbst aufkl&auml;ren.
    <div align="right">[ <a href="#top">top</a> ]</div>
    </blockquote>
...
<!-- CONFIGURATION -->
  ...
  <ul>
    ...
    <li><a href="#configuration.relatedlinks">Related Links</a>
    <li><a href="#configuration.relatedlinks_num">Anzahl Related Links</a>
  </ul>
    ...
    Die gesamte Liste von Platzhaltern findest Du auf der
    ...
    Hier kannst Du bestimmen ob man bei den News Related Links verwenden kann. Diese Links werden dann bei den
