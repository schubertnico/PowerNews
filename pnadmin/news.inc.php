...
<tr><td bgcolor="#3F5070" align="center"><b>
       ...
       <b class="headline"><?PHP echo L_TITLE_NEWS; ?></b>
...
if (isset($_GET['subpage']) && $_GET['subpage']) {
  ...
  if (in_array($requested_file, $allowed_files) && file_exists($requested_file)) {
    ...
    ?><center><?PHP echo L_ALL_CHOOSESUBPAGE; ?><br><br><a href="index.php?page=news&subpage=add"><?PHP echo L_NEWS_WRITENEWS; ?></a> | <a href="index.php?page=news&subpage=show"><?PHP echo L_NEWS_SHOWNEWS; ?></a> | <a href="index.php?page=news&subpage=search"><?PHP echo L_NEWS_SEARCHNEWS; ?></a></center><?PHP
  }
?>
