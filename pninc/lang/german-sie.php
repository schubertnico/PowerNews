...
define("L_USR_NOUSRREGISTERED", "Es ist kein Benutzer mit diesem Nickname/dieser E-Mail Adresse angemeldet!");
define("L_USR_TOOMANYSEARCHRESULTS", "Es sind zu viele Benutzer gefunden worden. Bitte spezifizieren Sie Ihre Suchangabe!");
define("L_USR_DATASENT", "Die Daten wurden erfolgreich an Ihre E-Mail Adresse gesandt!");
define("L_USR_CANTSENDMAIL", "Die Daten-E-Mail konnte nicht gesendet werden, bitte versuchen Sie es nochmals!");
define("L_USR_NICKNAMEOREMAILALREADYUSED", "Der gew&auml;hlte Nickname oder die gew&auml;hlte E-Mail Adresse wird bereits von einem anderen Benutzer genutzt!");
define("L_USR_PASSNOTEQUAL", "Die beiden angegeben Passw&ouml;rter stimmen nicht &uuml;berein!");
define("L_USR_NOTLOGGEDIN", "Sie sind nicht eingeloggt!");
define("L_USR_CANNOTLOGOUT", "Sie k&ouml;nnen Sich nicht ausloggen wenn Sie nicht eingeloggt sind!");
define("L_USR_PROFILEEDITED", "Ihr Profil wurde erfolgreich editiert. Sollten Sie Ihr Passwort ge&auml;ndert haben, so m&uuml;ssen Sie Sich erneut einloggen!");

/* News */
define("L_NEWS_NONEWS", "Keine News vorhanden");
define("L_NEWS_CHOOSENEWS", "Sie m&uuml;ssen einen g&uuml;ltigen Newseintrag w&auml;hlen!");
...
define("L_NEWS_WRONGCAT", "Ung&uuml;ltige Kategorie");
define("L_NEWS_NOHEADLINES", "Keine Headlines vorhanden");
define("L_NEWS_CANNOTPOSTCOMMENTS", "Sie k&ouml;nnen keine Kommentare posten wenn Sie nicht registriert und eingeloggt sind!");
...
define("L_NEWS_NOCATS_ERROR", "Fehler: Keine Kategorien verf&uuml;gbar! Bitte wenden Sie sich an den Administrator.");
define("L_NEWS_NOCATS_CANNOT_SEND", "News k&ouml;nnen derzeit nicht eingesendet werden, da keine Kategorien verf&uuml;gbar sind. Bitte versuchen Sie es sp&auml;ter erneut.");
define("L_NEWS_SELECTCAT_ERROR", "Bitte w&auml;hlen Sie eine Kategorie aus!");
define("L_NEWS_CHOOSECAT", "Kategorie w&auml;hlen");
define("L_NEWS_NEWSSENTIN", "Ihre News wurden erfolgreich eingesendet");
define("L_NEWS_CANNOTSENDNEWS", "Sie m&uuml;ssen registriert und eingeloggt sein um News senden zu k&ouml;nnen!");
define("L_NEWS_NONEWSSENDIN", "Es k&ouml;nnen keine News eingesendet werden!");
...
define("L_TEMPL_MARCH", "M&auml;rz");
...
/* Other */
define("L_ALL_FILLALL", "Sie m&uuml;ssen alle Felder ausf&uuml;llen!");
