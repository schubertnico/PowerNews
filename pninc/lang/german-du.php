...
define('L_USR_DATASENT', 'Die Daten wurden erfolgreich an Deine E-Mail Adresse gesandt!');
...
define('L_USR_PROFILEEDITED', 'Dein Profil wurde erfolgreich editiert. Solltest Du Dein Passwort ge&auml;ndert haben, so musst Du Dich erneut einloggen!');

/* News */
define('L_NEWS_NONEWS', 'Keine News vorhanden');
define('L_NEWS_CHOOSENEWS', 'Du musst einen g&uuml;ltigen Newseintrag w&auml;hlen!');
...
define('L_NEWS_NOCATS_ERROR', 'Fehler: Keine Kategorien verf&uuml;gbar! Bitte wende dich an den Administrator.');
define('L_NEWS_NOCATS_CANNOT_SEND', 'News k&ouml;nnen derzeit nicht eingesendet werden, da keine Kategorien verf&uuml;gbar sind. Bitte versuche es sp&auml;ter erneut.');
define('L_NEWS_SELECTCAT_ERROR', 'Bitte w&auml;hle eine Kategorie aus!');
define('L_NEWS_CHOOSECAT', 'Kategorie w&auml;hlen');
define('L_NEWS_NEWSSENTIN', 'Deine News wurden erfolgreich eingesendet');
define('L_NEWS_CANNOTSENDNEWS', 'Du musst registriert und eingeloggt sein um News senden zu k&ouml;nnen!');
...
/* Other */
define('L_ALL_FILLALL', 'Du musst alle Felder ausf&uuml;llen!');
